...
<div class="container mt-5" style="max-width:500px;">
    <h2 style="color:#1a7f37; font-size:2rem; text-decoration:underline;">Houdbaarheidsdatum wijzigen</h2>
    @if(session('error'))
    ...
    <form method="POST" action="{{ route('products.update', [$leverancier, $product]) }}" class="mt-4">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" value="{{ $product->naam }}" disabled>
        </div>
        <div class="mb-3">
            <label class="form-label">Huidige houdbaarheidsdatum</label>
            <input type="date" class="form-control" value="{{ $product->houdbaarheidsdatum }}" disabled>
        </div>
        <div class="mb-3">
            <label class="form-label">Nieuwe houdbaarheidsdatum</label>
